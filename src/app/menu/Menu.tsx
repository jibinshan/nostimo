  ...
  return (
    <section className="flex w-full max-w-[1300px] flex-row bg-menubg">
      <div className="flex w-full flex-col gap-4 md:w-4/6">
        ...
        >
          <div className="absolute left-0 top-0 flex h-full w-full items-end justify-end px-12 py-12">
            <Link href='/pdf/dine-in-menu.pdf' target="_blank">
              <Button className="flex items-center justify-center gap-2 bg-menusecondary rounded-none px-5 py-6 text-lg font-[600] text-menuforeground hover:bg-buttonhover">
        ...
        {/* Categories */}
        <div className="sticky top-0 z-10 flex items-center bg-transparent px-4 py-2">
          <div
            ref={categoryNavRef}
