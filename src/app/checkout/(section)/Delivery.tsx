      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="h-full">
          <div className="border-borderinput flex w-full flex-col items-start justify-between gap-3 border-b-[2px] py-3 pb-5">
            <p className="w-full text-xl font-semibold text-menuprimary-foreground">
              Delivery Time
            </p>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-menuprimary-foreground">
                      {scheduleTime.date || scheduleTime.time
                        ? `${format(scheduleTime?.date, "dd-MM-yyyy")},\u00A0${scheduleTime.time} `
                        : "Choose a time"}
                    </p>
                  </div>
                </div>
          ...
          <div className="border-b-borderinput flex flex-col gap-4 border-b-[2px] pb-7 pt-7">
            <div className="w-full lg:w-2/6">
              <p className="text-lg font-semibold text-menuprimary-foreground">
                Contact Details
              </p>
            </div>
                  ...
                  <FormItem className="w-full lg:w-4/5">
                    <FormControl>
                      <Input
                        placeholder="Name"
                        {...field}
                        className="h-12 rounded-none border-b-[3px] border-l-0 border-r-0 border-t-0 border-b-[#323232] bg-[#0c0c0c] outline-none placeholder:text-menuprimary-foreground focus-visible:border-b-[2px] focus-visible:border-b-[#bc995d] focus-visible:ring-0"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                ...
                render={({ field }) => (
                  <FormItem className="flex w-full flex-col gap-2">
                    ...
                    <FormControl>
                      <Textarea
                        rows={3}
                        className="border-none bg-[#0F0F0F] placeholder:text-menuprimary-foreground lg:w-4/5"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
