...
const Menu: React.FC = () => {
  return (
    <section className="relative h-full w-full bg-[#0C1213] px-4 py-12 lg:px-0 lg:py-24">
      <div className="absolute bottom-0 left-[40%] hidden h-full border-r-[1px] border-[#AF8032] lg:block"></div>
      <div className="absolute right-0 top-24 hidden w-[80%] border-t-[1px] border-[#AF8032] lg:block"></div>
      <div className="flex flex-col-reverse gap-12 lg:flex-row lg:gap-0">
        ...
        <div className="flex w-full flex-col gap-6 pt-10 lg:w-[60%] lg:gap-10 lg:pl-20 lg:pt-24">
          <div className="flex flex-col gap-4">
            ...
            <p className="w-full font-inter font-[300] leading-[20px] tracking-[0.36px] text-[#A59982] lg:w-[400px]">
          ...
          <div className="flex flex-col gap-5 lg:gap-8">
            <div className="flex flex-row items-center gap-8">
              <p className="font-marcellus flex flex-col text-base font-[400] text-[#A59982] lg:text-lg">
                Cake Sweet{" "}
              ...
              />
              <span className="font-inter text-base font-[600] text-[#A59982] lg:text-lg">
                25.00$
              </span>
            </div>
            <div className="flex flex-row items-center gap-8">
          ...
          <div className="mt-4 flex justify-center lg:ml-40 lg:mt-10 lg:justify-start 2xl:ml-56">
            <Button className="font-poppins rounded-none bg-[#AF8032] px-7 py-6 font-[500] tracking-[0.60px] text-[#fff] lg:px-12">
              View Menu
            </Button>
          </div>
        </div>
