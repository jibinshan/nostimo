      ...
      <DialogContent className="flex max-h-[625px] w-[90%] flex-col gap-3 bg-menubackground p-0 md:w-[625px]">
        ...
        <div className="px-5">
          <div className="rounded-xl bg-itembackground px-5 py-6">
            <p className="font-manrope grid grid-cols-2 items-center justify-start gap-1 text-sm text-menusecondary">
              {modifiers &&
                modifiers.length > 0 &&
                Object.entries(
                  modifiers.reduce(
          ...
          <div className="flex w-full items-center justify-center gap-4 px-5 py-5">
            ...
            >
              <Button
                ...
                className="w-full text-menusecondary"
              >
                I&apos;ll Choose
              </Button>
            </Link>
            <MenuItemDrawer item={item} setChoose={setOpen}>
              <Button
                variant="outline"
                className="w-1/2 text-menusecondary md:hidden"
              >
                I&apos;ll Choose
              </Button>
            </MenuItemDrawer>
